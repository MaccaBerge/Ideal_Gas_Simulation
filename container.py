...
class Container:
    ...
    def get_container_bounds(self) -> dict:
        """ Returns the bounds of the container. """
        return {"top": self.position[1], "bottom": self.position[1] + self.height, "left": self.position[0], "right": self.cap_hitbox.centerx}
